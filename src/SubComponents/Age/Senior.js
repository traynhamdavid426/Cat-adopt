...
const Senior =() => {
    ...
    <h1 className="tc">Senior</h1>
      <p>
        Temperament: Diet: Suspendisse in est ante in nibh. A condimentum
      ...
      <p>
        Pros: Suspendisse in est ante in nibh. A condimentum vitae sapien
        pellentesque habitant morbi tristique senectus. Cras pulvinar mattis
        nunc sed blandit. Augue eget arcu dictum varius. Faucibus scelerisque
        eleifend donec pretium vulputate sapien nec sagittis. Etiam erat velit
        scelerisque in dictum non consectetur. Morbi leo urna molestie at
        elementum. Blandit cursus risus at ultrices mi tempus imperdiet. Justo
        nec ultrices dui sapien. Tincidunt tortor aliquam nulla facilisi cras
        fermentum odio. At quis risus sed vulputate. Lobortis mattis aliquam
        faucibus purus in massa. Suspendisse potenti nullam ac tortor vitae
        purus faucibus ornare. Ut sem viverra aliquet eget. Malesuada nunc
        vel risus commodo viverra maecenas. Ultricies leo integer malesuada
        nunc vel risus commodo viverra.
      </p>
      <p>
        cons: Suspendisse in est ante in nibh. A condimentum vitae sapien
        pellentesque habitant morbi tristique senectus. Cras pulvinar mattis
        nunc sed blandit. Augue eget arcu dictum varius. Faucibus scelerisque
        eleifend donec pretium vulputate sapien nec sagittis. Etiam erat velit
        scelerisque in dictum non consectetur. Morbi leo urna molestie at
      ...
      <p>
        Special care: Egestas integer eget aliquet nibh praesent tristique
        magna sit amet. Ullamcorper a lacus vestibulum sed arcu non odio
        euismod. Dignissim suspendisse in est ante in nibh mauris. Suspendisse
        sed nisi lacus sed viverra. Nulla facilisi etiam dignissim diam quis
        enim lobortis scelerisque fermentum. Sagittis purus sit amet volutpat
        consequat mauris nunc congue nisi. Morbi tristique senectus et netus
        et malesuada fames ac turpis. Est lorem ipsum dolor sit amet.
        Venenatis tellus in metus vulputate eu scelerisque felis. Massa
        tincidunt nunc pulvinar sapien et ligula ullamcorper malesuada proin.
      ...
      <p>
        cons: Egestas integer eget aliquet nibh praesent tristique magna sit
        amet. Ullamcorper a lacus vestibulum sed arcu non odio euismod.
        Dignissim suspendisse in est ante in nibh mauris. Suspendisse sed nisi
        lacus sed viverra. Nulla facilisi etiam dignissim diam quis enim
        lobortis scelerisque fermentum. Sagittis purus sit amet volutpat
...
<button className="ml3" onClick={()=>{navigate('/senior')}}>back</button>
<button className="ml3" onClick={()=>{navigate('/geriatric')}}>Next</button>
</div>
</div></div>)}
